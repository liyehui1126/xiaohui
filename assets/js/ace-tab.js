 ...
 *更新时间：2016-4-14 21：17 完结 完全适应浏览器各种大小
    ...
    $.fn.aceaddtab = function (options) {
        ...
        var _loadContent = function () {
            ...
            if (_tabs.length == 1) {
                ...
                var tabContents = "<div class=\"tab-content\" style=\"padding: 0px;\">";
            ...
            if ($("#" + htmlID + " > ul > li[class*='dropdown']").size() == 1) {
                ...
                listHtml += "<i class=\"red fa fa-remove bigger-110\" style=\"cursor:pointer\"></i>";
            ...
            if ($("#" + htmlID + " > ul").outerHeight(true) < 50) {
                ...
                for (var i = 0; i < tabs.length; i++) {
                    ...
                    if (i != 0) {
                        ...
                        tabTitles += "<i class=\"red fa fa-remove bigger-110\" style=\"cursor:pointer\"></i>";
        ...
        var _closeTab = function () {
            ...
            $("#" + htmlID + " a i[class*='fa-remove']").click(function (e) {
